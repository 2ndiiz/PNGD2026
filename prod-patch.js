// PNGD2026 PROD fixes — promoted from validated DEV patch on 2026-08-30.
// Loaded only after StatiCrypt decrypts index.html.
(function () {
  ...
  console.info('[PNGD PROD] fixes 1-4 active');
})();
